              ...
              <div className='m-2 rounded' style={{ backgroundColor: '#EEEEEE'}}>
                <div className='p-2'>
                  ...
                  <input
                    ...
                    id="email"
                    type="text"
                    className="mt-1 ms-2 outline-none border border-secondary rounded-1"
                ...
                <div className="mt-10">
                  ...
                  <input
                    ...
                    id="password"
                    type="password"
                    className="mt-1 ms-2 mb-2 outline-none border border-secondary rounded-1"
                    style={{backgroundColor: '#FFFFDD'}}
                  />
                </div>
